...
class PublicCApi {
	...
	**/
	...
	static public function checkAnonFromPointer(haxeObject: HaxeObject<{str: String}>) {
	...
	// static public function nonTrivialCallback(a: cpp.Callable<(msg: String) -> Void>): Void {}
